...
// Cie10 SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class Cie10MakeRequest
{
    public static function call(Cie10Context $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new Cie10Response(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new Cie10Response($fetched);
        } else {
