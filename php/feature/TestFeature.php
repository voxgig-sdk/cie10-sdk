...
// Cie10 SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class Cie10TestFeature extends Cie10BaseFeature
{
    ...
    public function init(Cie10Context $ctx, array $options): void
    {
        ...
        $test_fetcher = function (Cie10Context $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (Cie10Context $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(Cie10Context $ctx, $op, $args): array
    {
