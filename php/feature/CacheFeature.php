...
class Cie10CacheFeature extends Cie10BaseFeature
{
    ...
    private function _through(Cie10Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
