...
class Cie10ProxyFeature extends Cie10BaseFeature
{
    ...
    public function init(Cie10Context $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (Cie10Context $ctx2, string $url2, array $fetchdef) use ($inner): array {
