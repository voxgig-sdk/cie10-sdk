...
class Cie10NetsimFeature extends Cie10BaseFeature
{
    ...
    private function _simulate(Cie10Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(Cie10Context $ctx, array $applied): void
    {
        $client = $this->client;
