...
class Cie10RatelimitFeature extends Cie10BaseFeature
{
    ...
    private function _acquire(Cie10Context $ctx): void
    {
    ...
    private function _track(Cie10Context $_ctx, float $wait_ms): void
    {
        $client = $this->client;
