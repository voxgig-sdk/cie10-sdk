...
class Cie10StreamingFeature extends Cie10BaseFeature
{
    ...
    private function _iterate(Cie10Result $result): \Generator
    {
    ...
    private function _streamable(Cie10Context $ctx): bool
    {
