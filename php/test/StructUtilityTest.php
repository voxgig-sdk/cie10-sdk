...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = Cie10Omni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(Cie10Omni::structfix($now, Struct::undef()))
                        !== json_encode(Cie10Omni::structfix($val, Struct::undef()))) {
