...
// Cie10 SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (Cie10SDK::test)
...
{
    private const SDK_CLASS = 'Cie10SDK';
    ...
    private const SDK_BASE = 'cie10_sdk';
