...
{
    private static function utility(): Cie10Utility
    {
        return new Cie10Utility();
    }
    ...
    private static function ctx(array $over = []): Cie10Context
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new Cie10Context([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new Cie10Operation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof Cie10Error) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new Cie10Operation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = Cie10MakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new Cie10Operation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = Cie10MakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new Cie10Operation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = Cie10MakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new Cie10Spec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = Cie10MakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new Cie10Response([]),
            'result' => new Cie10Result([]),
        ]);
        [, $err] = Cie10MakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new Cie10Spec(['step' => 's']),
            'response' => new Cie10Response(self::resp(404, null, ['x-a' => '1'])),
            'result' => new Cie10Result([]),
        ]);
        [, $err] = Cie10MakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new Cie10Spec(['step' => 's']),
            'response' => new Cie10Response(self::resp(200, ['v' => 1])),
            'result' => new Cie10Result([]),
        ]);
        [, $err] = Cie10MakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new Cie10Spec(['step' => 's']),
            'response' => new Cie10Response(self::resp(200, ['v' => 2])),
            'result' => new Cie10Result([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        Cie10MakeResponse::call($ctx);
    ...
    {
        $preset = new Cie10Response(self::resp(299));
        $ctx = self::ctx([
            'spec' => new Cie10Spec([]),
            'response' => new Cie10Response([]),
            'result' => new Cie10Result([]),
        ...
        [$got, $err] = Cie10MakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new Cie10Result([])]);
        [, $err] = Cie10MakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new Cie10Spec([]), 'result' => null]);
        [, $err] = Cie10MakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new Cie10Spec(['step' => 's']),
            'result' => new Cie10Result(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new Cie10Operation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = Cie10MakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new Cie10Spec(['step' => 's']),
            'result' => new Cie10Result(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new Cie10Operation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = Cie10MakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new Cie10Result(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new Cie10Spec([]),
            'result' => new Cie10Result([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = Cie10MakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $utility = self::utility();
        $boom = new Cie10Error('boom', 'boom');
        $utility->fetcher = function (Cie10Context $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new Cie10Spec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = Cie10MakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (Cie10Context $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = Cie10MakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(Cie10Response::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (Cie10Context $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new Cie10Spec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = Cie10MakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new Cie10Response(self::resp(201));
        $ctx = self::ctx(['spec' => new Cie10Spec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = Cie10MakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = Cie10MakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = Cie10MakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new Cie10Result(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, Cie10Done::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new Cie10Result(['ok' => false])]);
        $this->expectException(Cie10Error::class);
        Cie10Done::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new Cie10Result(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', Cie10MakeError::call($ctx, null));
    }
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new Cie10BaseFeature();
        $b = new Cie10BaseFeature();
        Cie10FeatureAdd::call($ctx, $a);
        Cie10FeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): Cie10BaseFeature
    {
        $f = new Cie10BaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    private static function auth_ctx(array $options, ?array $headers): Cie10Context
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new Cie10Spec(['headers' => $headers]),
        ]);
    }
    ...
    {
        $ctx = self::ctx([
            'response' => new Cie10Response(['headers' => null]),
            'result' => new Cie10Result([]),
        ]);
        Cie10ResultHeaders::call($ctx);
