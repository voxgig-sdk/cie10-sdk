...
class Cie10TestRunner
{
    ...
    {
        $live = self::getenv('CIE10_TEST_LIVE');
        $override = self::getenv('CIE10_TEST_OVERRIDE');
        ...
        $explain = self::getenv('CIE10_TEST_EXPLAIN');
...
class_alias('Cie10TestRunner', 'Runner');
class_alias('Cie10Helpers', 'Helpers');
