...
from cie10_sdk.utility import register

# Load features
from cie10_sdk.feature.base_feature import Cie10BaseFeature
from cie10_sdk.features import _has_feature, _make_feature
...
class Cie10SDK:
    ...
    def get_utility(self):
        return Cie10Utility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("Cie10SDK: graphql: " + str(msg))
            res["graphql"] = errors

        return res


    def Cie10(self, data=None) -> "Cie10Entity":
        """Entity factory: client.Cie10().list() / client.Cie10().load({"id": ...})."""
        from cie10_sdk.entity.cie_10_entity import Cie10Entity
        return Cie10Entity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "Cie10SDK":
        if sdkopts is None:
            sdkopts = {}
