...
from cie10_sdk.cie10_types import (
    Cie10,
    Cie10ListMatch,
)
...
class Cie10Entity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return Cie10Entity(self._client, opts)
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[Cie10]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.Cie10().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
