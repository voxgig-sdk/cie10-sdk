# Cie10 SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions Cie10SDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both Cie10SDK(...) and Cie10SDK.test(...) become
#      Cie10SDK.test({"entity": {...}}) seeding one mock record (id "test01")
