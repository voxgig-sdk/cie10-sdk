...
from cie10_sdk.utility.voxgig_struct.voxgig_struct import (
...
runner = makeRunner(STRUCT_TEST_JSON, Cie10SDK.test(None, None))
...
class TestStructUtility(unittest.TestCase):
    ...
    def test_minor_joinurl(self):
        from cie10_sdk.utility.voxgig_struct.voxgig_struct import join as struct_join
