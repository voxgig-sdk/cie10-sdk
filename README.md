...
Learn more about NotaSalud CIE-10 Search API at [notasalud.com/api-cie-10](https://notasalud.com/api-cie-10).

This is an unofficial SDK for the NotaSalud CIE-10 Search public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
This SDK exposes the API as a small set of **semantic entities** — Cie10 — that you
...
| --- | --- | --- |
| **Cie10** | The Cie10 entity (list). | `/buscar/cie-10` |
...
$cie10s = $client->Cie10()->list();
print_r(array_map(fn($item) => $item->data_get(), $cie10s));
```
...
Generated from the NotaSalud CIE-10 Search API OpenAPI spec by [@voxgig/sdkgen](https://github.com/voxgig/sdkgen).
