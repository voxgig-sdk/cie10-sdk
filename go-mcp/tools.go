...
type Args struct {
	Entity string         `json:"entity" jsonschema:"cie_10"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.Cie10SDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "cie10_list",
		Description: "List records from Cie10. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "cie10_load",
		Description: "Load a single record from Cie10. " +
...
func runOp(client *sdk.Cie10SDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.Cie10SDK, name string) (sdk.Cie10Entity, error) {
	switch strings.ToLower(name) {
	case "cie_10":
		return client.Cie10(nil), nil
