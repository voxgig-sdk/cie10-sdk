...
module Cie10TestRunner
  ...
  def self.env_override(m)
    live = getenv("CIE10_TEST_LIVE")
    override = getenv("CIE10_TEST_OVERRIDE")
    ...
    explain = getenv("CIE10_TEST_EXPLAIN")
    m["CIE10_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = Cie10TestRunner
Helpers = Cie10Helpers
Vs = VoxgigStruct
