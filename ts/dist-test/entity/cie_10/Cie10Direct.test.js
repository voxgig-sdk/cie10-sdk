...
(0, node_test_1.describe)('Cie10Direct', async () => {
    ...
    (0, node_test_1.test)('direct-list-cie_10', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-cie_10', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.CIE10_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.Cie10SDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['CIE10_TEST_CIE_10_ENTID'];
...
//# sourceMappingURL=Cie10Direct.test.js.map