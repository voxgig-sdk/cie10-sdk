...
(0, node_test_1.describe)('exists', async () => {
    ...
    //
    // Cie10SDK.test() is synchronous — it returns the client, not a promise
    ...
    (0, node_test_1.test)('test-mode', () => {
        ...
        (0, node_assert_1.equal)(testsdk instanceof __1.Cie10SDK, true, 'Cie10SDK.test() must return a client synchronously');
    });
});
