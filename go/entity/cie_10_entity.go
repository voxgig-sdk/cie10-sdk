...
type Cie10Entity struct {
	name    string
	client  *core.Cie10SDK
...
func NewCie10Entity(client *core.Cie10SDK, entopts map[string]any) *Cie10Entity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *Cie10Entity) GetName() string { return e.name }
...
func (e *Cie10Entity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *Cie10Entity) Deleted() bool {
	return e.deleted
}


func (e *Cie10Entity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCie10Entity(e.client, opts)
}

func (e *Cie10Entity) Data(args ...any) any {
...
func (e *Cie10Entity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Cie10; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *Cie10Entity) DataTyped(data ...Cie10) Cie10 {
	if len(data) > 0 {
		return typedFrom[Cie10](e.Data(asMap(data[0])))
	}
	return typedFrom[Cie10](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Cie10 (all fields
// optional at the wire level).
func (e *Cie10Entity) MatchTyped(match ...Cie10) Cie10 {
	if len(match) > 0 {
		return typedFrom[Cie10](e.Match(asMap(match[0])))
	}
	return typedFrom[Cie10](e.Match())
}
...
func (e *Cie10Entity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *Cie10Entity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *Cie10Entity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// Cie10ListMatch and returns []Cie10. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *Cie10Entity) ListTyped(reqmatch Cie10ListMatch, ctrl map[string]any) ([]Cie10, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Cie10](res), nil
}



func (e *Cie10Entity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *Cie10Entity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *Cie10Entity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *Cie10Entity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
