...
func plClient(t *testing.T, sdkopts map[string]any) (*sdk.Cie10SDK, *sdk.Utility) {
	t.Helper()
	client := sdk.TestSDK(nil, sdkopts)
	return client, client.GetUtility()
}

func plCtx(client *sdk.Cie10SDK, utility *sdk.Utility, ctrl map[string]any) *sdk.Context {
