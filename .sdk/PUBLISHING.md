...
|---|---|---|
| `ts/` | @voxgig-sdk/cie10-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/cie10-sdk \
      --repository voxgig-sdk/cie10-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/cie10-sdk` shows it, and
`npm trust revoke @voxgig-sdk/cie10-sdk --id=<id>` removes it.
