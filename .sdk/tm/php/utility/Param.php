...
// Cie10 SDK utility: param

require_once __DIR__ . '/../core/Helpers.php';

class Cie10Param
{
    public static function call(Cie10Context $ctx, mixed $paramdef): mixed
    {
        $point = $ctx->point;
        $spec = $ctx->spec;
        $match_val = $ctx->match;
        ...
        $akey = '';
        if ($point) {
            $alias_map = Cie10Helpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'alias'));
            if ($alias_map) {
