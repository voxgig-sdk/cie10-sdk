...
class Cie10Fetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; Cie10SDK/1.0)';
    ...
    public static function call(Cie10Context $ctx, string $fullurl, array $fetchdef): array
    {
