...
class Cie10ClienttrackFeature extends Cie10BaseFeature
{
    ...
    public function PostConstruct(Cie10Context $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Cie10-SDK';
