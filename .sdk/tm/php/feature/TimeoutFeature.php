...
class Cie10TimeoutFeature extends Cie10BaseFeature
{
    ...
    private function _with_timeout(Cie10Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(Cie10Context $_ctx, float $ms): void
    {
        $client = $this->client;
