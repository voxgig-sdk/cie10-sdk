...
class Cie10RbacFeature extends Cie10BaseFeature
{
    ...
    private function _required(Cie10Context $ctx): ?string
    {
    ...
    private function _reject(Cie10Context $ctx, string $required): void
    {
    ...
    private function _track(Cie10Context $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
