...
from projectname_sdk.core.control import Cie10Control
...
class Cie10Context:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, Cie10Response):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return Cie10Error(code, msg, self)
