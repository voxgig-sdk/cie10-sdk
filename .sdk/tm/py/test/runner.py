...
class Cie10TestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = Cie10TestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = Cie10TestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = Cie10TestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
