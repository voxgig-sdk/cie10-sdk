...
class Cie10TestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = Cie10TestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = Cie10TestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = Cie10TestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
