...
from projectname_sdk import Cie10SDK
from projectname_sdk.core.spec import Cie10Spec
from projectname_sdk.core.result import Cie10Result
from projectname_sdk.core.response import Cie10Response
from projectname_sdk.core.operation import Cie10Operation
from projectname_sdk.core.error import Cie10Error
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import Cie10BaseFeature
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = Cie10SDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = Cie10SDK.test(None, None)
        ...
        class TestInitFeature(Cie10BaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(Cie10BaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = Cie10SDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = Cie10SDK.test(None, setup_opts)
