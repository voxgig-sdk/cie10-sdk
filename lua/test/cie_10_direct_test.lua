...
describe("Cie10Direct", function()
  it("should direct-list-cie_10", function()
    local setup = cie_10_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-cie_10", setup.live and "live" or "unit")
