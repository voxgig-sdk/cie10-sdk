...
local Cie10Entity = {}
Cie10Entity.__index = Cie10Entity


function Cie10Entity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, Cie10Entity)
  self._name = "cie_10"
  self._client = client
...
function Cie10Entity:get_name()
  return self._name
end


function Cie10Entity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return Cie10Entity.new(self._client, opts)
end
...
function Cie10Entity:mark_deleted()
  self._deleted = true
end


function Cie10Entity:deleted()
  return true == self._deleted
end


function Cie10Entity:data_set(args)
  if args ~= nil then
...
function Cie10Entity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function Cie10Entity:match_set(args)
  if args ~= nil then
...
function Cie10Entity:match_get()
...
function Cie10Entity:stream(action, args, callopts)
...
---@param reqmatch Cie10ListMatch
---@param ctrl? table
---@return Cie10[]
---@return string? err
function Cie10Entity:list(reqmatch, ctrl)
  local utility = self._utility
...
function Cie10Entity:_run_op(ctx, post_done)
  local utility = self._utility
